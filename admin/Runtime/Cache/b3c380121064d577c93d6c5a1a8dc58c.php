...
--></style><div style="text-align:center"><div class="content ok" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:330px;"><?php echo ($message); ?></div><?php if(isset($jump_url)): ?><script language="javascript">		redirect('<?php echo ($jump_url); ?>');
    </script><?php endif; if(isset($dialog)): ?><script style="text/javascript">	var dialog = "<?php echo ($dialog); ?>";
